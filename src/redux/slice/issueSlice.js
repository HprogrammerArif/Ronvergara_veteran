...
const categoryMap = {
    ...
    // TBI Related
    'Traumatic Brain Injury': 'Traumatic Brain Injury Related',
  };
...
//   // After removal, get the updated selected categories
//   const selectedCategories = getState().issueSlice.selectedCategories;

//   // Find the next category to navigate to
//   const nextCategory = selectedCategories[0] || "";  // Set to empty if no categories left
