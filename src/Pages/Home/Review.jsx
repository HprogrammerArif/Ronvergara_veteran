...
const Review = () => {
  ...
  return (
    <section className=" bg-gray-200">
      <div className="py-16 px-4 md:px-8 container mx-auto relative">
        {/* Decorative Background Elements */}
      
        {/* Section Header */}
        <div className="text-center mb-16 relative">
          {/* <span className="inline-block px-4 py-2 bg-red-600 text-white text-sm font-semibold rounded-full mb-4 transform transition-all hover:scale-105">
            Success Stories
          </span> */}
