...
//                 <Link
//                   to="/plan"
//                   className="bg-[#003794] text-white font-semibold text-2xl px-8 py-5 rounded-md uppercase tracking-wide inline-block "
//                 >
...
//         <p className="text-orange-500 px-2 text-lg text-start font-semibold tracking-wider uppercase mb-4">
      ...
      <div className="block min-h-screen pb-10 pt-32 md:hidden bg-gradient-to-b from-blue-50 to-blue-100 text-center relative overflow-hidden">
        {(!loggedInUser || !hasSubscription) ? (
          <>
            ...
            <h1 className="text-3xl font-bold text-[#003794] leading-tight px-2 text-start">
              Submit your va
            </h1>
            <h1 className="text-3xl font-bold mb-4 px-2 text-[#003794] leading-tight text-start">
              <span className="text-[#003794]">disability claim</span> today with <span className="text-4xl font-extrabold">valr</span>
