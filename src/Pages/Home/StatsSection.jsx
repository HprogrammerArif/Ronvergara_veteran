import { FaUser, FaStar, FaGraduationCap, FaRibbon } from "react-icons/fa"; 

const StatsSection = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center gap-6 p-6 min-h-[30vh] lg:min-h-[50vh] bg-gray-200">
...
// const StatsSection = () => {
//   return (
//     <div className="flex flex-col md:grid md:grid-cols-3 justify-center items-center gap-6 p-6 min-h-[50vh] md:min-h-[40vh] bg-gray-200">
//       {/* Card 1: 100% Success Rate */}
//       <div className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center justify-center w-full max-w-xs mx-auto">
//         <div className="relative text-[#001F3F] text-4xl mb-4">
//           <FaUser className="w-12 h-12" />
//           <FaStar className="w-6 h-6 absolute top-0 right-0 -translate-y-2 translate-x-2" />
//         </div>
