...
//   return (
//     <div className="max-w-6xl mx-auto p-8 md:py-20">
...
//           <h1 className="capitalize mb-1 text-sm">Dependent children <br />under 18</h1>
//           <select
//             name="under18"
//             className="bg-[#2B3B4E] text-white p-2 rounded w-full"
//             value={dependents.under18}
...
//             name="maritalStatus"
//             className="bg-[#2B3B4E] text-white p-2 rounded w-full"
//             value={dependents.maritalStatus}
//             onChange={handleChange}
//           >
...
//         {/* Number of SMC(K) */}
//         <div  className="flex justify-between flex-col">
//           <h1 className="capitalize mb-1 text-sm">Number of SMC(K)</h1>
//           <select
//             name="smcr"
//             className="bg-[#2B3B4E] text-white p-2 rounded w-full"
//             value={dependents.smcr}
//             onChange={handleChange}
//           >
//             {["NONE", 1, 2, 3, 4, 5].map((num) => (
//               <option key={num} value={num}>{num}</option>
//             ))}
//           </select>
//         </div>
...
//         Disclaimer: please note that this calculation tool is to be used as an estimated evaluation and for
//         informational purposes only. many factors are considered with veteran affair calculations, ratings, and monetary
//         amounts. please contact veteran advocate center for additional questions or assistance with va.
//       </div>
//     </div>
//   )
// }
