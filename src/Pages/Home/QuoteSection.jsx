...
export default function SliderWithQuotes() {
  ...
  return (
    <div className="bg-white">
      {/* Slides section - unchanged from your original */}
  ...
  <div className="relative bg-gradient-to-r from-[#000000]/95 to-[#3533cd] rounded-2xl overflow-hidden shadow-2xl min-h-[400px] border border-gray-200">
    <div className="relative flex flex-col lg:flex-row h-full md:min-h-[400px]">
      ...
      <div className="w-full lg:w-2/5 p-6 md:p-8 flex flex-col justify-center  text-white">
        <div className="mb-4">
          <h3 className="text-2xl md:text-3xl font-bold mb-2 text-center md:text-start">{currentQuote.author}</h3>
          {currentQuote.role && (
            <p className="text-white text-sm text-center md:text-start">{currentQuote.role}</p>
          )}
          <p className="text-white text-sm mt-2 text-center md:text-start">{currentQuote.bio}</p>
        </div>
      </div>
