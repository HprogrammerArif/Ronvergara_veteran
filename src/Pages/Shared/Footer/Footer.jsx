      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
          ...
          <div className="mb-4 md:mb-0">
            <img src={logo} alt="logo"  className="flex items-center mx-auto  h-[75px] w-[90px] mb-5"/>
            <p className=" text-gray-300 text-base text-center md:max-w-md w-[330px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-6">
          {/* Helpful Links */}
          <div>
            <h3 className="text-base font-semibold mb-4 underline">HELPFUL LINKS</h3>
          ...
          {/* Contact Information */}
          <div>
            <h3 className="text-base font-semibold mb-4 underline">CONTACT INFORMATION</h3>
            <ul className="space-y-2 text-gray-300">
