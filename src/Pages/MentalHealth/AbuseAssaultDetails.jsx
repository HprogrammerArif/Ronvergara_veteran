        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 flex-grow md:mt-10 mt-5">
          ...
          <label className="block text-lg font-medium text-gray-700">
            ...
            <select
              ...
              className={`mt-1 block w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm ${errors.abusedAssaulted ? 'border-red-500' : ''}`}
            >
