...
// // const livesCrashAccident = watch("livesCrashAccident");
...
//               className={`mt-1 block w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm ${errors.cleanedCrashSite ? 'border-red-500' : ''}`}
//             >
...
//               <option value="industrialWorkplace" selected>Industrial/Workplace Accident</option>
...
//               className={`mt-1 block w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 h-32 text-sm resize-none ${errors.incidentDetails ? 'border-red-500' : ''}`}
      ...
      <div className="md:p-6 p-2 rounded-lg w-full max-w-4xl flex flex-col justify-between">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 flex-grow mt-5 px-1 md:px-0">
          ...
          <label className="block text-lg font-medium text-gray-700">
            ...
            <select
              {...register("cleanedCrashSite", { required: "This field is required" })}
              className={`mt-1 block w-full uppercase p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm ${errors.cleanedCrashSite ? 'border-red-500' : ''}`}
            >
          ...
          {cleanedCrashSite === "yes" && (
            <>
              ...
              <label className="block text-lg font-medium text-gray-700">
                ...
                <select
                  {...register("incidentType", { required: "This field is required" })}
                  className={`mt-1 block w-full uppercase p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm ${errors.incidentType ? 'border-red-500' : ''}`}
                >
              ...
              <label className="block text-lg font-medium text-gray-700 ">
                ...
                <textarea
                  {...register("incidentDetails", { required: "This field is required" })}
                  className={`mt-1 block w-full p-2 uppercase border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 h-32 text-sm resize-none ${errors.incidentDetails ? 'border-red-500' : ''}`}
                  placeholder="Enter details here..."
                />
                {errors.incidentDetails && <span className="text-red-500 text-sm">{errors.incidentDetails.message}</span>}
              </label>
