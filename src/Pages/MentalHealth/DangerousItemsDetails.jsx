    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100 pt-24 pb-10 mt-10">
      <div className="md:p-6 p-2 rounded-lg w-full max-w-4xl flex flex-col justify-between">
       ...
       <div className="bg-[#002B5C] w-full rounded-lg p-6 mb-6 flex flex-col items-center">
        ...
        {/* Form Section */}
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 flex-grow pt-5">
          {/* Did You Handle Dangerous Items? */}
          <label className="block text-lg font-medium text-gray-700">
            Did You Handle Dangerous Items?
            <select
              {...register("handledDangerousItems", { required: "This field is required" })}
              className={`mt-1 block w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm ${errors.handledDangerousItems ? 'border-red-500' : ''}`}
            >
          ...
          <label className="block text-lg font-medium text-gray-700">
            ...
            <select
              ...
              className={`mt-1 block w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm ${errors.itemType ? 'border-red-500' : ''}`}
            >
