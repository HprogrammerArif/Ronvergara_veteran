...
//               <option value="National Guard">Space Force</option>
//               <option value="National Guard">NOAA</option>
//               <option value="National Guard">USPHS</option>
//             </select>
  ...
  {errors.branchOfService && <span className="text-red-500 text-sm">{errors.branchOfService.message}</span>}
        ...
        {formData && (
          <div className="mt-6 p-4 bg-gray-100 rounded-md">
            <h2 className="text-lg font-bold text-blue-800 mb-4">Submitted Information:</h2>
