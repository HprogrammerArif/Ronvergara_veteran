...
//               <span className="text-red-500 text-sm">
//                 {errors.TelephoneNumber_FirstThreeNumbers[0].message}
//               </span>
//             )}
//             {errors.TelephoneNumber_SecondThreeNumbers?.[0] && (
//               <span className="text-red-500 text-sm">
//                 {errors.TelephoneNumber_SecondThreeNumbers[0].message}
//               </span>
//             )}
//             {errors.TelephoneNumber_LastFourNumbers?.[0] && (
//               <span className="text-red-500 text-sm">
//                 {errors.TelephoneNumber_LastFourNumbers[0].message}
//               </span>
//             )}
//           </div>
...
//             {errors.DOB_Month?.[0] && (
//               <span className="text-red-500 text-sm">
//                 {errors.DOB_Month[0].message}
//               </span>
//             )}
//             {errors.DOB_Day?.[0] && (
//               <span className="text-red-500 text-sm">
//                 {errors.DOB_Day[0].message}
//               </span>
//             )}
//             {errors.DOB_Year?.[0] && (
//               <span className="text-red-500 text-sm">
//                 {errors.DOB_Year[0].message}
//               </span>
//             )}
//           </div>
...
//               <span className="text-red-500 text-sm">
//                 {errors.Beginning_Date_Month[0].message}
//               </span>
//             )}
//             {errors.Beginning_Date_Day?.[0] && (
//               <span className="text-red-500 text-sm">
//                 {errors.Beginning_Date_Day[0].message}
//               </span>
//             )}
//             {errors.Beginning_Date_Year?.[0] && (
//               <span className="text-red-500 text-sm">
//                 {errors.Beginning_Date_Year[0].message}
//               </span>
//             )}
//           </div>
...
//               <span className="text-red-500 text-sm">
//                 {errors.Ending_Date_Month[0].message}
//               </span>
//             )}
//             {errors.Ending_Date_Day?.[0] && (
//               <span className="text-red-500 text-sm">
//                 {errors.Ending_Date_Day[0].message}
//               </span>
//             )}
//             {errors.Ending_Date_Year?.[0] && (
//               <span className="text-red-500 text-sm">
//                 {errors.Ending_Date_Year[0].message}
//               </span>
//             )}
//           </div>
...
//           <div>
//             <label className="block text-sm font-medium text-gray-700">
//               Mailing Address (Street, Apt/Unit, City, State, ZIP, Country)
//             </label>
...
//                 <input
//                   type="text"
//                   {...register("MailingAddress_ApartmentOrUnitNumber[0]", {
...
//                   <span className="text-red-500 text-sm">
//                     {errors.MailingAddress_ApartmentOrUnitNumber[0].message}
//                   </span>
//                 )}
//               </div>
//               <div className="w-[25%]">
...
//breakdown code using progress bar
