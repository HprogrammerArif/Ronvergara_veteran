      ...
      <div className="form-control">
        ...
        <div className="relative">
          <input
            ...
            className={`input input-bordered py-5 w-full pl-10 focus:ring-0${
      ...
      <div className="form-control">
        ...
        <div className="relative">
          <input
            ...
            className={`input input-bordered py-5 w-full pl-10 ${
      ...
      <div className="form-control">
        ...
        <div className="relative">
          <input
            ...
            className={`input input-bordered py-5 w-full pl-10 focus:ring-2 focus:ring-primary focus:border-primary ${
