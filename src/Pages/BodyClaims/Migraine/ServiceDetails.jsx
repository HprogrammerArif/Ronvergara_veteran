        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 px-1 md:px-0">
          ...
          <label className="block text-sm font-medium text-gray-700">
            ...
            <input
              ...
              type="text"
              className={`mt-1 block w-full p-2 border uppercase border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm ${errors.jobRole ? 'border-red-500' : ''}`}
          ...
          <label className="block text-sm font-medium text-gray-700">
            ...
            <textarea
              ...
              className={`mt-1 block w-full p-2 border uppercase border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm h-32 resize-none ${errors.responsibilities ? 'border-red-500' : ''}`}
